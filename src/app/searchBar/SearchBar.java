...
public final class SearchBar {
    private List<DatabaseEntry> results;
    ...
    @Getter
    private DatabaseEntry lastSelected;
     ...
     * @return the list
     */
    public List<DatabaseEntry> search(final Filters filters, final String type) {
     ...
     */
    public DatabaseEntry select(final Integer itemNumber) {
