...
public final class Song extends AudioFile {
    ...
    /**
     * increases a song revenue
     * @param songRevenue -> the amount with which the revenue is increased
     */
    public void addRevenue(final double songRevenue) {
        this.revenue += songRevenue;
    }
