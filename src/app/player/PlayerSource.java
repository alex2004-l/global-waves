...
public class PlayerSource {
    ...
    @Getter
    private ArrayList<AudioFile> playHistory = new ArrayList<>();
    ...
    public PlayerSource(final Enums.PlayerSourceType type, final AudioFile audioFile) {
        ...
        this.playHistory.add(audioFile);
    }
    ...
    public void skip(final int duration) {
        ...
        if (remainedDuration > audioFile.getDuration()) {
            remainedDuration = 0;
            if (!getAudioFile().getName().equals("Ad Break")) {
                index++;
                updateAudioFile();
            }
